...
do
    ...
    L["恭喜你们击杀尾王！YY%s你曾评价为：|cff%s>>%s<<。|r"] = "Congratulations on killing the final boss! You previously rated YY%s as: |cff%s>>%s<<.|r"
    L["恭喜你们击杀尾王！由于没有记录到团长YY，快速评价框不会弹出。"] = "Congratulations on killing the final boss! Since the raid leader's YY was not recorded, the quick rating popup will not appear."
    ...
    L["|cffffffff< 共享我的评价 >   （你已共享|r |cff00FF00%s|r |cffffffff人次评价）|r\n\n1、当别人查询大众评价时，如果你有该YY的评价，则会以匿名的方式共享给对方\n2、如果你不开启该功能，则你的查询大众评价功能会被禁用，因为共享是相互的\n3、开启该功能后，会使聊天记录里的YY号变为超链接\n4、没满级的角色会被禁止共享和使用查询大众评价"] = "|cffffffff< Share My Rating > (You have shared |r |cff00FF00%s|r |cffffffff ratings)|r\n\n1. When others query public ratings, your YY rating is shared anonymously if you have one.\n2. If you do not enable this feature, your public rating lookup will be disabled because sharing is mutual.\n3. After enabling this feature, YY numbers in chat logs become hyperlinks.\n4. Characters below max level cannot share or use public rating lookup."
