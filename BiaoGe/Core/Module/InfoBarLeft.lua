...
BG.Init(function()
    ...
    -- 在线玩家数
    if BG.IsTW or BG.IsWLK then
        if BG.IsTW and not BG.IsWLK then
            BG.Init2(function()
        ...
        local World = LOOK_FOR_GROUP or "LookingForGroup"
        ...
        if ChannelFrame and ChannelFrame.ChannelList and ChannelFrame.ChannelList.AddChannelButtonInternal then
