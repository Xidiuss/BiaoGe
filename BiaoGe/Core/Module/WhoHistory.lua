    ...
    bt:SetScript("OnClick", function(self)
        if not self.frame then
            ...
            do
                ...
                local scroll = CreateFrame("ScrollFrame", "BiaoGeWhoHistoryQueryScroll", f, "UIPanelScrollFrameTemplate")
                scroll.ScrollBar = scroll.ScrollBar or _G["BiaoGeWhoHistoryQueryScrollScrollBar"]
            ...
            do
                ...
                local scroll = CreateFrame("ScrollFrame", "BiaoGeWhoHistoryWebScroll", f, "UIPanelScrollFrameTemplate")
                scroll.ScrollBar = scroll.ScrollBar or _G["BiaoGeWhoHistoryWebScrollScrollBar"]
                scroll:SetWidth(f:GetWidth() - 10)
                scroll:SetHeight(f:GetHeight() - 10)
                scroll:SetPoint("CENTER")
                scroll.ScrollBar.scrollStep = BG.scrollStep
