...
BG.Init2(function()
    ...
    do
        ...
        if AchievementIDs then
            ...
            local bt = CreateFrame("CheckButton", "BiaoGeMHAchievementCheck", f, "ChatConfigCheckButtonTemplate")
            bt.Text = bt.Text or _G["BiaoGeMHAchievementCheckText"]
            bt:SetSize(25, 25)
        ...
        do
            ...
            local bt = CreateFrame("CheckButton", "BiaoGeMHiLevelCheck", f, "ChatConfigCheckButtonTemplate")
            bt.Text = bt.Text or _G["BiaoGeMHiLevelCheckText"]
            bt:SetSize(25, 25)
        ...
        do
            ...
            -- 职业
            local bt = CreateFrame("CheckButton", "BiaoGeMHOtherCheck1", f, "ChatConfigCheckButtonTemplate")
            bt.Text = bt.Text or _G["BiaoGeMHOtherCheck1Text"]
            bt:SetSize(25, 25)
            ...
            -- 经验
            local bt = CreateFrame("CheckButton", "BiaoGeMHOtherCheck2", f, "ChatConfigCheckButtonTemplate")
            bt.Text = bt.Text or _G["BiaoGeMHOtherCheck2Text"]
            bt:SetSize(25, 25)
