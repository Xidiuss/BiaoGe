...
function BG.HistoryUI()
    ...
    do
        ...
        local scroll = CreateFrame("ScrollFrame", "BiaoGeHistoryScroll", BG.History.List, "UIPanelScrollFrameTemplate") -- 滚动
        scroll.ScrollBar = scroll.ScrollBar or _G["BiaoGeHistoryScrollScrollBar"]
