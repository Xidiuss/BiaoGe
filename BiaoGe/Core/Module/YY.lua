...
BG.Init(function()
    ...
    do
        ...
        local today = tonumber(date("%y%m%d", GetServerTime()))
    ...
    do
        ...
        do
            ...
            local scroll = CreateFrame("ScrollFrame", "BiaoGeYYScroll", f, "UIPanelScrollFrameTemplate")
            scroll.ScrollBar = scroll.ScrollBar or _G["BiaoGeYYScrollScrollBar"]
    ...
    do
        ...
        local scroll = CreateFrame("ScrollFrame", "BiaoGeYYMyScroll", BG.YYMainFrame.my, "UIPanelScrollFrameTemplate")
        scroll.ScrollBar = scroll.ScrollBar or _G["BiaoGeYYMyScrollScrollBar"]
        ...
        function Y.SetAll()
            ...
            previous_date = previous_date or 0
            for ii, _ in ipairs(BiaoGe.YYdb.all) do
                local yyData = BiaoGe.YYdb.all[ii]
                local right
                local yyDate = tonumber(yyData.date)
                local isOutTime = yyDate and previous_date > yyDate or false
                for i, _ in ipairs(title_table) do
                    ...
                    local date = yyDate and tostring(yyDate) or "000000"
                    date          = strsub(date, 1, 2) .. "/" .. strsub(date, 3, 4) .. "/" .. strsub(date, 5, 6)
                    local i_table = { ii, date, yyData.yy, yyData.name, Y.Pingjia(yyData.pingjia),
                        yyData.edit }
    ...
    do
        ...
        do
            ...
            local scroll = CreateFrame("ScrollFrame", "BiaoGeYYResultScroll", BG.YYMainFrame.result, "UIPanelScrollFrameTemplate")
            scroll.ScrollBar = scroll.ScrollBar or _G["BiaoGeYYResultScrollScrollBar"]
                ...
                for ii, _ in ipairs(BiaoGe.YYdb.history[num].all) do
                    if BiaoGe.YYdb.historyFilter == 0 or BiaoGe.YYdb.history[num].all[ii].pingjia == BiaoGe.YYdb.historyFilter then
                        ...
                        for i, _ in ipairs(title_table) do
                            ...
                            local date    = tonumber(BiaoGe.YYdb.history[num].all[ii].date) and tostring(BiaoGe.YYdb.history[num].all[ii].date) or "000000"
                            date          = strsub(date, 1, 2) .. "/" .. strsub(date, 3, 4) .. "/" .. strsub(date, 5, 6)
    ...
    do
        ...
        do
            ...
            do
                ...
                local scroll = CreateFrame("ScrollFrame", "BiaoGeYYEndPJScroll", f, "UIPanelScrollFrameTemplate")
                scroll.ScrollBar = scroll.ScrollBar or _G["BiaoGeYYEndPJScrollScrollBar"]
                scroll:SetWidth(f:GetWidth() - 10)
                scroll:SetHeight(f:GetHeight() - 10)
                scroll:SetPoint("CENTER")
                scroll.ScrollBar.scrollStep = BG.scrollStep
    ...
    BG.Init2(function()
        ...
        do
            ...
            if ChannelFrame.ChannelList and ChannelFrame.ChannelList.AddChannelButtonInternal then
