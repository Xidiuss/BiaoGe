            ...
            for i = 1, HopeMaxi, 1 do
                ...
                do
                    ...
                    bt:SetScript("OnTextChanged", function(self)
                        ...
                        local itemID = tonumber((GetItemInfoInstant(itemText)))
                        if itemID then
        ...
        bt:SetScript("OnClick", function(self)
            ...
            if not self.bg then
                ...
                do
                    ...
                    self.sbg = sbg
                    scroll = CreateFrame("ScrollFrame", "BiaoGeHopeImportScroll", sbg, "UIPanelScrollFrameTemplate")
                    scroll.ScrollBar = scroll.ScrollBar or _G["BiaoGeHopeImportScrollScrollBar"]
        ...
        bt:SetScript("OnClick", function(self)
            ...
            if not self.bg then
                ...
                do
                    ...
                    sbg:SetFrameLevel(130)
                    self.sbg = sbg
                    scroll = CreateFrame("ScrollFrame", "BiaoGeHopeExportScroll", sbg, "UIPanelScrollFrameTemplate")
                    scroll.ScrollBar = scroll.ScrollBar or _G["BiaoGeHopeExportScrollScrollBar"]
                    scroll:SetPoint("TOPLEFT", 5, -4)
                    scroll:SetPoint("BOTTOMRIGHT", -27, 4)
                    scroll.ScrollBar.scrollStep = BG.scrollStep
                    BG.CreateSrollBarBackdrop(scroll.ScrollBar)
