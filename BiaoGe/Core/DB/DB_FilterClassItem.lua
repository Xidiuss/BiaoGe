...
BG.Init(function()
    ...
    if BG.IsMOP then
        BG.Once("FilterClassItemDB", 250904, function()
    ...
    do
        BG.FilterClassItemDB.Icon = {
            ...
            ["HUNTER" .. "1"] = { icon = "Interface/Icons/ability_hunter_beasttaming", name = L["猎人"] }, -- LR
            ...
            ["ROGUE" .. "1"] = { icon = "Interface/Icons/ability_stealth", name = L["盗贼"] }, -- DZ

            ["WARLOCK" .. "1"] = { icon = "Interface/Icons/spell_shadow_deathcoil", name = L["术士"] }, -- SS

            ["MAGE" .. "1"] = { icon = "Interface/Icons/spell_frost_frostbolt02", name = L["法师"] }, -- FS
        ...
        local legacyIcons = {
            ["Interface/Icons/classicon_hunter"] = "Interface/Icons/ability_hunter_beasttaming",
            ["Interface/Icons/classicon_rogue"] = "Interface/Icons/ability_stealth",
            ["Interface/Icons/classicon_warlock"] = "Interface/Icons/spell_shadow_deathcoil",
            ["Interface/Icons/classicon_mage"] = "Interface/Icons/spell_frost_frostbolt02",
        }
        for i = 1, MaxFilter[class] do
            local filter = BiaoGe.FilterClassItemDB[RealmID][player][i]
            if filter.Icon and legacyIcons[filter.Icon] then
                filter.Icon = legacyIcons[filter.Icon]
            end
            if not filter.Icon then
                filter.Icon = BG.FilterClassItemDB.Icon[class .. i].icon
                filter.Name = BG.FilterClassItemDB.Icon[class .. i].name
            end
        end
    ...
    do
        ...
        for k, v in pairs(BG.FilterClassItemDB.ShuXing) do
            ...
            elseif BG.FilterClassItemDB.ShuXing[k].value then
        ...
        if BG.IsRetail then
            ...
            if BG.verLess2 then
                BG.FilterClassItem_Default.Weapon = {
                    ...
                    ["DRUID" .. "1"]   = { G["单手斧"], G["双手斧"], G["弓"], G["枪"], G["单手剑"], G["双手剑"], G["双手锤"], G["长柄武器"], G["投掷武器"], G["弩"], G["魔杖"] }, -- 咕咕
                    ...
                    ["DRUID" .. "4"]   = { G["单手斧"], G["双手斧"], G["弓"], G["枪"], G["单手剑"], G["双手剑"], G["双手锤"], G["长柄武器"], G["投掷武器"], G["弩"], G["魔杖"] }, -- ND
            ...
            elseif BG.IsMOP then
                BG.FilterClassItem_Default.Weapon = {
                    ...
                    ["DEATHKNIGHT" .. "2"] = { G["弓"], G["枪"], G["法杖"], G["拳套"], G["匕首"], G["投掷武器"], G["弩"], G["魔杖"] }, -- DK
                    ...
                    ["HUNTER" .. "1"]      = { G["单手斧"], G["单手剑"], G["单手锤"], G["拳套"], G["匕首"], G["长柄武器"], G["双手斧"], G["双手剑"], G["双手锤"], G["法杖"], G["投掷武器"], G["魔杖"] }, -- LR
