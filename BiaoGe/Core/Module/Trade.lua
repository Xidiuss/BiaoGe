...
BG.Init(function()
    ...
    do
        ...
        do
            ...
            f:EnableMouse(true)
            f:SetToplevel(true)
            f:SetFrameLevel((TradeRecipientMoneyBg and TradeRecipientMoneyBg:GetFrameLevel() or 5) + 1)
            f:SetFrameStrata("HIGH")
        ...
        -- 本次交易自动记账
        do
            local bt = CreateFrame("CheckButton", "BiaoGeTradeAutoCheck", BG.tradeSeeFrame.frame, "ChatConfigCheckButtonTemplate")
            bt.Text = bt.Text or _G["BiaoGeTradeAutoCheckText"]
            bt:SetSize(20, 20)
        ...
        -- 本次交易记为罚款
        do
            local bt = CreateFrame("CheckButton", "BiaoGeTradeFakuanCheck", BG.tradeSeeFrame.frame, "ChatConfigCheckButtonTemplate")
            bt.Text = bt.Text or _G["BiaoGeTradeFakuanCheckText"]
        ...
        -- 本次交易记为退货
        do
            local bt = CreateFrame("CheckButton", "BiaoGeTradeRefundCheck", BG.tradeSeeFrame.frame, "ChatConfigCheckButtonTemplate")
    ...
    do
        ...
        function BG.CreateTradeFastGiveMoneyFrame()
            ...
            frame:SetBackdropBorderColor(.5, .5, .5, .5)
            frame.scroll = CreateFrame("ScrollFrame", "BiaoGeTradeFastMoneyScroll", frame, "UIPanelScrollFrameTemplate")
            frame.scroll.ScrollBar = frame.scroll.ScrollBar or _G["BiaoGeTradeFastMoneyScrollScrollBar"]
    ...
    do
        ...
        bt:SetFrameLevel((TradeRecipientMoneyBg and TradeRecipientMoneyBg:GetFrameLevel() or 5) + 15)
        bt:SetText(L["复制应付金额"])
        bt:Hide()
        ...
        local bt = CreateFrame("CheckButton", "BiaoGeTradeCopyCheck", UIParent, "ChatConfigCheckButtonTemplate")
        bt.Text = bt.Text or _G["BiaoGeTradeCopyCheckText"]
        bt:SetSize(30, 30)
        bt.Text:SetFont(BIAOGE_TEXT_FONT, 15, "OUTLINE")
