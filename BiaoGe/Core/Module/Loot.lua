    ...
    if BG.IsTitan then
        ...
        do
            ...
            do
                ...
                local scroll = CreateFrame("ScrollFrame", "BiaoGeLootAuctionLogScroll", frame, "UIPanelScrollFrameTemplate")
                scroll.ScrollBar = scroll.ScrollBar or _G["BiaoGeLootAuctionLogScrollScrollBar"]
