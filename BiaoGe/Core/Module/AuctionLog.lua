...
BG.Init(function()
    ...
    do
        do
            ...
            f:SetScript("OnMouseDown", function(self, button)
                BG.MainFrame:GetScript("OnMouseDown")(BG.MainFrame, button)
            end)
        ...
        do
            ...
            scroll = CreateFrame("ScrollFrame", "BiaoGeAuctionLogScroll", frame, "UIPanelScrollFrameTemplate")
            scroll.ScrollBar = scroll.ScrollBar or _G["BiaoGeAuctionLogScrollScrollBar"]
    ...
    do
        ...
        -- 自动生成账单
        do
            local bt = CreateFrame("CheckButton", "BiaoGeAutoCreateBillCheck", f, "ChatConfigCheckButtonTemplate")
            bt.Text = bt.Text or _G["BiaoGeAutoCreateBillCheckText"]
            bt:SetSize(30, 30)
    ...
    do
        ...
        do
            ...
            do
                ...
                f.item = t
                t.title = title
                BG.SafeHyperlinkScript(_f, "OnHyperlinkEnter", function(self, link, text, button)
                ...
                BG.SafeHyperlinkScript(_f, "OnHyperlinkLeave", GameTooltip_Hide)
            end
        ...
        do
            local function CancelChoose(bt)
                ...
                if bt.num % 2 == 0 then
                    ...
                    bt.tex:SetColorTexture(0, 0, 0, 0)
                end
            end
