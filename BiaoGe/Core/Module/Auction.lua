...
BG.Init(function()
    ...
    local function UpdateGuildFrame(frame)
        ...
        elseif IsInGuild() then
            ...
            numOnline = numOnline or numTotal or 0
        ...
        function BG.StartAuction(link, bt, isNotAuctioned, notAlt, isRightButton, noSound, callback)
            ...
            do
                ...
                for i, v in ipairs(items) do
                    ...
                    ftex:SetScript("OnMouseDown", function(self, button)
                        mainFrame:GetScript("OnMouseDown")(mainFrame, button)
                    end)
            ...
            do
                ...
                edit:SetFrameLevel(mainFrame:GetFrameLevel() + 20)
            ...
            do
                ...
                dropDown:SetFrameLevel(mainFrame:GetFrameLevel() + 20)
            ...
            do
                ...
                bt:SetFrameLevel(mainFrame:GetFrameLevel() + 20)
            ...
            if BiaoGe.options["fastMoney"] == 1 then
                ...
                mainFrame.fastMoneyFrame:SetFrameLevel(mainFrame:GetFrameLevel() + 20)
                ...
                local function CreateButton()
                    ...
                    bt:SetSize(50, 20)
                    bt:SetFrameLevel(mainFrame.fastMoneyFrame:GetFrameLevel() + 1)
                    bt:RegisterForClicks("LeftButtonUp", "RightButtonUp")
                    if #buttons == 0 then
        ...
        local function OnClick(self, button)
            ...
            elseif button == "RightButton" then
                if self.frame and self.frame:IsVisible() then
                    ...
                    self.edit = edit
                    local scroll = CreateFrame("ScrollFrame", "BiaoGeAuctionWAScroll", f, "UIPanelScrollFrameTemplate")
                    scroll.ScrollBar = scroll.ScrollBar or _G["BiaoGeAuctionWAScrollScrollBar"]
