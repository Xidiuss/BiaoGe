...
function BG.ItemLibUI()
    ...
    do
        ...
        do
            ...
            bt.normalTex:SetTexture("Interface\\Icons\\INV_Misc_Map_01")
            bt.normalTex:SetTexCoord(0.07, 0.93, 0.07, 0.93)
            ...
            bt.highlightTex:SetTexture("Interface\\Icons\\INV_Misc_Map_01")
            bt.highlightTex:SetTexCoord(0.07, 0.93, 0.07, 0.93)
