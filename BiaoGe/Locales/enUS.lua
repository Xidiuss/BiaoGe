...
do --英语说明书
    ns.instructionsText = {
        ...
        " ",
        "|cffFFFFFF-Open command: |r/BiaoGe or /GBG, or bind keys in game settings. Minimap icon: " .. "|TInterface\\AddOns\\BiaoGe\\Media\\icon\\icon.tga:16:16:0:0|t",
        "|cffFFFFFF-Quick operation: |r|TInterface\\AddOns\\BiaoGe\\Media\\icon\\rightc.tga:16:16:0:0|t input box clears content",
        ...
        "|cffFFFFFF-Auction countdown: |r|TInterface\\AddOns\\BiaoGe\\Media\\icon\\rightc.tga:16:16:0:0|t chat box equipment starts auction and counts down automatically (when you are the group leader or item distributor)",
        "|cffFFFFFF-Quick accounting: |r|TInterface\\AddOns\\BiaoGe\\Media\\icon\\rightc.tga:16:16:0:0|t chat box opens when equipped (when you are a member)",
...
do
    ...
    L["商人"] = "Merchant"
    L["末日行者"] = "Doomwalker"
    L["末日行者卡扎克"] = "Doomwalker / Doom Lord Kazzak"
    L["炼金"] = "Alchemy"
    L["毒蛇神殿"] = "Serpentshrine Cavern."
    L["风暴要塞"] = "Tempest Keep"
    ...
    L["拾取牌子时，增加显示该牌子的现有数量。"] = "When picking up tokens, show the current amount for that token."
    L["拾取牌子时，如果已经达到该牌子的数量上限，播放语音提醒。"] = "When picking up tokens, play a voice alert if you have reached the cap for that token."
    L["在部分物品的提示文本中，增加显示该牌子的数量。比如在熊猫人之怒的正义奖章里，提示正义点数现有数量。"] = "Show token counts in some item tooltips. For example, show the current Justice Point count for Justice Badges in Mists of Pandaria."
    L["英雄难度"] = "Heroic Difficulty"
    L["普通难度"] = "Normal Difficulty."
    L["确定清空<%s>的所有历史表格？"] = "Make sure to clear all history tables for <%s>?"
    L["清空历史表格"] = "Empty history tables"
    L["魔古山"] = "Mogu'shan Vaults"
    L["恐惧"] = "Heart of Fear"
    L["永春台"] = "Terrace of Endless Spring"
    L["T14套"] = "T14 set"
    L["勇气"] = "Courage"
    L["正义"] = "Justice"
    L["天神"] = "The August Celestials"
    L["罚款合计：%s"] = "Total fines: %s"
    L["（合计%s）"] = "(Total %s)"
    L["烹饪技能点"] = "Cooking Skill Points"
    ...
    L["根据YY评价标记活动"] = "Mark activities by YY rating"
    ...
    L["自动出价的延迟时间随机"] = "Randomize auto-bid delay"
    L["启用自动出价时，当别人出价后，默认是自己会延迟0.5秒后才自动出价。"] = "When auto-bidding is enabled, your bid is delayed by 0.5 seconds by default after someone else bids."
    L["现在可以修改这个延迟时间，并在一定范围内随机（%s秒-X秒）。X最低为%s秒，最高为%s秒。"] = "You can change this delay and randomize it within a range (%s seconds to X seconds). X is at least %s seconds and at most %s seconds."
    L["瓦兰奈尔碎片"] = "Fragment of Val'anyr"
    L["查看教程"] = "View Tutorial"
    L["我想成为语音包作者"] = "I want to become a voice pack author"
    L["通过搜索组队频道的活动也会显示[密语]按钮。"] = "Activities found by searching the LookingForGroup channel will also show the [Whisper] button."
    L["v3.0：修复了拍卖框架的一个重叠问题"] = "v3.0: Fixed an overlapping issue with auction frames."
    L["声望"] = "Reputation"
    L["提醒团长：如果你没有物品分配权，将会导致交易的相关功能失效。"] = "Raid leader reminder: without loot distribution permissions, trade-related features will not work."
    L["禁用语音开团快人一步"] = "Disable Voice-Opened Tours"
    L["活动列表顶部的语音开团快人一步将会被禁用，其活动将会合并到常规活动里。"] = "The fast voice group-start entry at the top of the activity list will be disabled, and its activities will be merged into regular activities."
    L["影霜碎片"] = "Shadowfrost Shard"
    L["埃提耶什的碎片"] = "Splinter of Atiesh"
    ...
    L["|cff00ff00已完成任务|r"] = "|cff00ff00Quest completed|r"
    ...
    L["调试模式"] = "Debug Mode"
    L["你可以在该模式，调整拍卖UI的位置，预览UI缩放和层级效果。只能在非团队状态下使用。"] = "In this mode, you can adjust the auction UI position and preview UI scale and frame level effects. It can only be used outside a raid group."
    ...
    L["|cffff0000（该团长为毛团，请注意！如想举报更多毛团，请在抖音发视频后@苍穹之霜）|r"] = "|cffff0000 (This raid leader is flagged for ninja looting. To report more ninja-loot raids, post a video on Douyin and tag @Cangqiongzhishuang)|r"
    ...
    L["战刃"] = "Warblade"
    L["请你删除aaa插件，该插件会破坏系统的通讯功能，导致其他插件功能失效。"] = "Please remove the aaa AddOn. It breaks addon communication and causes other addons to stop working."
    ...
    L["%s人工资"] = "%s-player payroll"
    L["一键发工资"] = "One click payroll"
    L["在交易界面右上角，增加一键发工资和补贴的按钮，仅团长可见。"] = "Add one-click payroll and subsidy buttons to the top-right of the trade window, visible only to the raid leader."
    ...
    L["在你的WA面板里未找到拍卖WA字符串，你需要先从表格左上角的\"拍卖WA\"按钮导入该字符串。"] = "The Auction WA string was not found in your WA panel. Import it first from the \"Auction WA\" button in the top-left of the table."
    ...
    L["SHIFT+点击：把WA字符串通过密语发送给没有的团员。"] = "SHIFT+click: send the WA string by whisper to raid members who do not have it."
    L["错误"] = "Error"
    L["装等-名字"] = "Item Level-Name"
    L["职业-名字"] = "Class-Name"
    L["名字"] = "Name"
    ...
    L["|cffFFFFFF安装WA：|r此WA是团员端，用于接收团长发出的拍卖消息，没安装的团员显示不了拍卖UI。请团长安装该WA字符串后发给团员安装。如果团员已经安装了BiaoGe插件，可以不用安装该WA。"] = "|cffFFFFFFInstall WA:|r This WA is for raid members and receives auction messages from the raid leader. Members without it cannot see the auction UI. The raid leader should install this WA string and send it to raid members. If a raid member already has the BiaoGe AddOn installed, this WA is not required."
    ...
    L["工程技能点"] = "Engineering Skill Points"
    ...
    L["提醒：你可能还没拾取刚击杀BOSS的掉落哦！"] = "Reminder: You may not have looted the boss drops yet!"
    L["装备未拾取提醒"] = "Gear Not Picked Up Reminder"
    L["击杀BOSS超过30秒装备还没拾取，且你是物品分配者时，屏幕中间红字提醒。"] = "If boss drops have not been looted more than 30 seconds after the kill and you are the loot distributor, a red alert appears in the center of the screen."
    ...
    L["打开/关闭表格"] = "Open/Close Table"
    L["打开/关闭角色总览"] = "Open/Close Character Overview"
    ...
    L["25红玉"] = "25 Ruby Sanctum"
    L["10红玉"] = "10 Ruby Sanctum"
    L["25冰冠"] = "25 Icecrown Citadel"
    L["10冰冠"] = "10 Icecrown Citadel"
    L["25十字军"] = "25 Trial of the Crusader"
    L["10十字军"] = "10 Trial of the Crusader"
    L["25黑龙"] = "25 Onyxia's Lair"
    L["10黑龙"] = "10 Onyxia's Lair"
    L["25奥杜尔"] = "25 Ulduar"
    L["10奥杜尔"] = "10 Ulduar"
    L["25纳克"] = "25 Naxxramas"
    L["10纳克"] = "10 Naxxramas"
    L["25蓝龙"] = "25 Eye of Eternity"
    L["10蓝龙"] = "10 Eye of Eternity"
    L["25黑曜石"] = "25 Obsidian Sanctum"
    L["10黑曜石"] = "10 Obsidian Sanctum"
    L["25宝库"] = "25 Vault of Archavon"
    L["10宝库"] = "10 Vault of Archavon"
    ...
    L["标记已密语过的活动"] = "Mark activities already whispered"
    ...
    L["装等-职业-名字"] = "Item Level-Class-Name"
    L["装等-名字-职业"] = "Item Level-Name-Class"
    L["职业-装等-名字"] = "Class-Item Level-Name"
    L["职业-名字-装等"] = "Class-Name-Item Level"
    L["名字-装等-职业"] = "Name-Item Level-Class"
    L["名字-职业-装等"] = "Name-Class-Item Level"
    ...
    L["你可在插件设置-BiaoGe-其他功能-查询记录里关闭这个功能。"] = "You can disable this feature in AddOn Settings - BiaoGe - Other Features - Query Records."
    L["关闭名单"] = "Close list"
    ...
    L["v2.3：拍卖框体右上角的隐藏按钮改为折叠按钮"] = "v2.3: The hide button in the top-right of the auction frame was changed to a collapse button."
    L["提交BUG"] = "Submit Bug"
    ...
    L["使用组合键打开团长拍卖面板"] = "Use a modifier key to open the raid leader's auction panel."
    ...
    L["法强+奶强"] = "Spell Power + Healing Power"
    L["仅加法强，不加奶强，治疗需要过滤此词缀"] = "Only adds spell power, not healing power. Healers should filter out this affix."
    L["这个词缀是赛季服新增的，指物理和法系的命中，治疗需要过滤此词缀"] = "This season affix refers to physical and spell hit. Healers should filter it out."
    L["法术和效果造成的治疗提高"] = "Healing from spells and effects is increased."
    L["未知"] = "Unknown"
    ...
    L["这个词缀是指“法术治疗提高最多x点，法术伤害提高最多x点”，法系DPS一般需要过滤此词缀"] = "This affix means healing from spells is increased by up to X and spell damage is increased by up to X. Spell DPS usually should filter it out."
    L["风王子"] = "Wind Prince"
    L["黑龙"] = "Black Dragon"
    L["蓝龙"] = "Blue Dragon"
    L["卡扎克"] = "Lord Kazzak"
    L["使用组合键打开拍卖面板"] = "Use a modifier key to open the auction panel."
    L["团长/物品分配者ALT+点击背包/表格/聊天框装备，来打开拍卖面板。"] = "Raid Leader/Loot Distributor ALT-click gear in the bag, table, or chat frame to open the auction panel."
    L["出价记录"] = "Bid Record"
    L["、"] = ". "
    ...
    L["v2.0：重做进入动画；按组合键时可以发送或观察装备"] = "v2.0: Reworked the entry animation; you can send or inspect gear while holding a modifier key."
    L["司卡奇"] = "Sikaki"
    L["匕首岭-<TIMEs>贝西"] = "Daggers Ridge-<TIMES>Bessie"
    L["|cffFFFFFF买家：|r"] = "|cffFFFFFF buyer:|r"
    L["万"] = "Wan"
    L["拥有传说物品"] = "Possession of Lore Items"
    L["团员成就："] = "Raid Member Achievements:"
    ...
    L["查看团员的团本成就完成情况（该功能引用于比较成就里的API）"] = "View raid members' raid achievement completion (this feature uses the Compare Achievements API)."
    L["<未拍>"] = "<Untapped>"
    L["未拍"] = "Not"
    ...
    L["自动拍卖"] = "AutoAuction"
    L["调整自动拍卖UI的大小。"] = "Adjust the Auto Auction UI size."
    ...
    L["倒数自动暂停"] = "Countdown auto-pause"
    L["正在自动倒数时，如果有人出价（在团队频道打出纯数字时），则自动暂停倒数。"] = "During auto-countdown, if someone bids by typing a plain number in raid chat, the countdown pauses automatically."
    ...
    L["v1.8：增加出价记录；UI缩小了一点；提高了最小加价幅度"] = "v1.8: Added bid records; reduced UI size a bit; increased the minimum bid increment."
    L["当前难度："] = "Curr Diff: "
    L["账单"] = "Bills"
    L["用时"] = "Time spent"
    L["消费"] = "Purch"
    ...
    L["该BOSS攻略提供：@祈福-太乙公会 大树\n点击复制NGA攻略地址"] = "This boss guide is provided by @Benediction - Taiyi Guild Dashu\nClick to copy NGA guide URL"
    ...
    L["聊天频道显示星团长标记"] = "Show star raid leader marker in chat channels"
    L["在聊天频道（综合、组队等）/鼠标提示工具/目标右键菜单中，显示星团长标记。"] = "Show the star raid leader marker in chat channels (General, LookingForGroup, etc.), tooltips, and target right-click menus."
    L["需要集结号v2.0.0或以上版本才能生效。"] = "Requires Rally v2.0.0 or above to take effect."
    L["正在上传"] = "Uploading"
    L["已上传"] = "Uploaded"
    L["未上传"] = "Not uploaded"
    L["团本锁定ID"] = "Raid Lockout ID"
    L["账单表格："] = "Billing form:"
    ...
    L["把账单上传到新手盒子，点击后会重载一次游戏，请你确保新手盒子是正在运行。"] = "Upload the bill to Newbie Box. Clicking this will reload the game once, so make sure Newbie Box is running."
    ...
    L["比如："] = "For example:"
    L["点击地下城和团队副本时，会自动显示25人奥杜尔；"] = "When you click Dungeons & Raids, 25-player Ulduar is shown automatically;"
    L["点击专业制造时，会自动显示附魔；"] = "When clicking Professions, Enchanting is automatically displayed;"
    ...
    L["，"] = ","
    L["："] = ":"
    L["账单识别错误或超时！"] = "Bill recognition error or timed out!"
    ...
    L["< 角色5人本完成总览 >"] = "< Character 5-player completion overview >"
    L["BiaoGe的配置文件中，大部分都是账号互通的，比如当前表格、历史表格、YY评价、设置。但也有一些是按角色来保存的，比如心愿清单、装备过滤方案、集结号的搜索记录和密语模板。\n\n当一个角色改名或者转服时，该角色的心愿清单等数据就会丢失。所以该功能就是为了帮你找回原来的角色数据。"] = "Most BiaoGe profiles are shared across the account, such as the current table, history tables, YY ratings, and settings. Some profiles are saved per character, such as wishlist, gear filter plans, Rally search history, and whisper templates.\n\nWhen a character is renamed or transferred, data such as that character's wishlist can be lost. This feature helps you recover the original character data."
    ...
    L["集结号历史搜索记录"] = "Rally Search History"
    ...
    L["调整装备记录通知和交易通知的位置。"] = "Adjust the positions of Gear Record and Trade notifications."
    L["快捷命令：/BGM"] = "Shortcut command: /BGM"
    ...
    L["打开表格界面时，自动获取当前阵营在线人数。如果你打开表格时出现掉线的情况，请关闭该功能。"] = "When you open the table, automatically get the number of players online in the current faction. If you disconnect when opening the table, disable this feature."
    ...
    L["AI语音"] = "AI Voice"
    L["樱雪"] = "Sakura Yuki"
    L["举报成功后自动隐藏感谢界面"] = "Auto-hide thank-you screen after successful report"
    ...
    L["（"] = "("
    L["）"] = ")"
    L["|cff%s感谢你的评价：YY%s，>>%s<<%s。|r"] = "|cff%sThanks for your rating of %s: >>%s<<%s.|r"
    L["恭喜你们击杀尾王！YY%s你曾评价为：|cff%s>>%s<<。|r"] = "Congratulations on killing the final boss! You previously rated %s as: |cff%s>>%s<<.|r"
    L["恭喜你们击杀尾王！由于没有记录到团长YY，快速评价框不会弹出。"] = "Congratulations on killing the final boss! Since the raid leader's nickname was not recorded, the quick rating popup will not appear."
    L["这个词缀是赛季服新增的，指物理和法系的命中，治疗一般需要过滤此词缀"] = "This is a new season affix for physical and spell hit. Healers usually should filter it out."
    L["这个词缀是指物理命中"] = "This affix refers to physical hits."
    L["这个词缀是指物理爆击"] = "This affix refers to physical critical strike."
    L["这个词缀是指法术命中"] = "This prefix is for spell hits."
    L["这个词缀是指法术爆击"] = "This is the spell 'Critical Strike."
    L["这个词缀是指单纯增加法术伤害，治疗一般需要过滤此词缀"] = "This affix only increases spell damage. Healers usually should filter it out."
    L["这个词缀是指增加法术伤害和治疗，物理职业一般需要过滤此词缀"] = "This affix increases spell damage and healing. Physical classes usually should filter it out."
    L["这个词缀是指某种属性的法术伤害，比如增加火焰法术伤害，治疗一般需要过滤此词缀"] = "This affix increases spell damage of a specific school, such as Fire spell damage. Healers usually should filter it out."
    L["这个词缀是指单纯增加治疗效果，法系DPS一般需要过滤此词缀"] = "This affix only increases healing. Spell DPS usually should filter it out."
    L["所有法术和攻击的命中"] = "Hit for all spells and attacks"
    L["查询成功：YY%s的评价一共%s个。|cffFFFFFF|cff00FF00%s|r/|cffFFFF00%s|r/|cffDC143C%s|r|r。%s"] = "Successful query: %s has %s ratings. |cffFFFFFF|cff00FF00%s|r/|cffFFFF00%s|r/|cffDC143C%s|r|r. %s"
    L["查询成功：YY%s的评价一共%s个。%s"] = "Query successful: %s has a total of %s ratings. %s"
    ...
    L["删除该名玩家在BiaoGe插件里的全部举报记录。\n\n|cff808080你可在插件设置-BiaoGe-其他功能里关闭这个功能。|r"] = "Delete all report records for this player in the BiaoGe AddOn.\n\n|cff808080You can disable this feature in AddOn Settings - BiaoGe - Other Features.|r"
    L["遭劫货物"] = "Waylaid Supplies"
    L["在专业制造面板和专业学习面板中，高亮与[遭劫货物]有关物品。"] = "Highlight items related to [Waylaid Supplies] in the profession crafting and profession trainer panels."
    L["在拍卖行Shift点击[遭劫货物]时，只会搜索其所需货物，而不是搜索[遭劫货物]（支持原生界面和Auctionator插件）。"] = "When Shift-clicking [Waylaid Supplies] in the Auction House, search only the required supply items instead of [Waylaid Supplies] itself (supports the default UI and Auctionator)."
    L["UI缩放"] = "UI Zoom"
    ...
    L["调整背景材质透明度。"] = "Adjust background texture opacity."
    ...
    L["输入金额和欠款时自动加两个0，减少记账操作，提高记账效率。"] = "Automatically add two zeros when entering amounts and debts to reduce bookkeeping work and improve efficiency."
    ...
    L["你已给该YY写过评价！"] = "You have already rated this nickname!"
    ...
    L["未填写YY，不能保存。"] = "A nickname is required before saving."
    ...
    L["秒"] = "Seconds"
    L["%s%s已就绪！"] = "%s%s ready!"
    L["荆棘谷血月活动期间自动释放尸体和对话自动复活"] = "Automatically release corpse and auto-resurrect through dialogue during the Stranglethorn Vale Blood Moon event"
    L["挂机"] = "Hanger"
    ...
    L["在目标玩家/聊天频道玩家的右键菜单里增加一键举报脚本按钮。快捷命令：/BGReport。"] = "Add a one-click report script button to the target player/chat channel player's right-click menu. Shortcut command: /BGReport."
    ...
    L["你可在插件设置-BiaoGe-其他功能里关闭这个功能。"] = "You can disable this feature in AddOn Settings - BiaoGe - Other Features."
    ...
    L["工程"] = "Engineering"
    L["团本"] = "Raid"
    L["小团本%s"] = "Small Raid%s"
    L["你击中目标"] = "You hit your target."
    L["你造成爆击"] = "You critically strike."
    L["你的法术击中"] = "Your spell hits."
    L["你的法术造成爆击"] = "Your spell critically strikes."
    L["当前没有满级角色"] = "There are no full level Characters at this time."
    L["恶意骚扰"] = "Malicious Harassment"
    L["自动脚本"] = "Automated Scripting"
    L["已举报<%s>为%s。"] = "Has reported <%s> for %s."
    L["选择举报理由：%s\n选择举报项目：%s\n填写举报细节：%s\n\n快捷命令：/BGReport\n\n|cff808080你可在插件设置-BiaoGe-其他功能里关闭这个功能。|r"] = "Choose the report reason: %s\nChoose the report category: %s\nEnter report details: %s\n\nShortcut command: /BGReport\n\n|cff808080You can disable this feature in AddOn Settings - BiaoGe - Other Features.|r"
    L["一键举报RMT"] = "One Click Report RMT"
    L["选择举报理由：%s\n选择举报项目：%s\n填写举报细节：%s\n\n|cff808080你可在插件设置-BiaoGe-其他功能里关闭这个功能。|r"] = "Select report reason: %s\nSelect report category: %s\nEnter report details: %s\n\n|cff808080You can disable this feature in AddOn Settings - BiaoGe - Other Features.|r"
    ...
    L["工资抹零"] = "Erase"
    L["选择举报理由：作弊\n选择举报项目：外挂\n填写举报细节：自动脚本 自動腳本 Automatic Scripting\n\n快捷命令：/BGReport\n\n|cff808080你可在插件设置-BiaoGe-其他功能里关闭这个功能。|r"] = "Choose the report reason: Cheating\nChoose the report category: Third-party software\nEnter report details: 自动脚本 自動腳本 Automatic Scripting\n\nShortcut command: /BGReport\n\n|cff808080You can disable this feature in AddOn Settings - BiaoGe - Other Features.|r"
    L["|cffFFFFFF左键：|r搜索该记录"] = "|cffFFFFFFLeft click: |rSearch this record."
    L["|cffFFFFFF右键：|r删除该记录"] = "|cffFFFFFFRight click: |rDelete the record"
    L["一键举报"] = "One-click reporting"
    L["在目标玩家的右键菜单里增加一键举报脚本按钮。快捷命令：/BGReport。"] = "Add a one-click report script button to the target player's context menu. Shortcut command: /BGReport."
    L["多个关键词搜索"] = "Multiple keyword search"
    L["搜索框支持多个关键词搜索，每个关键词用空格隔开。"] = "The search box supports multiple keywords, separated by spaces."
    L["已举报<%s>。"] = "Reported <%s>."
    ...
    L["历史搜索记录"] = "Search History"
    L["给集结号的搜索框增加一个历史搜索记录，提高你搜索的效率。"] = "Add search history to the Rally search box to improve search efficiency."
    L["按队伍人数排序"] = "Sort by Team Size"
    L["集结号活动可以按队伍人数排序。"] = "Rally events can be sorted by team size."
    L["预设装等、自定义文本，当你点击集结号活动密语时会自动添加该内容。"] = "Preset item level and custom text will be added automatically when you whisper a Rally activity."
    ...
    L["在贸易局声望的遭劫货物提示工具中增加具体的声望奖励。如果你安装了Auctionator插件，还会显示所需货物的拍卖行价格。"] = "Add specific reputation rewards to the Waylaid Supplies tooltip. If Auctionator is installed, the auction house price of the required supply item is also shown."
    ...
    L["贸易局的遭劫货物显示具体声望奖励"] = "Show specific reputation rewards for Waylaid Supplies"
    L["在贸易局声望的遭劫货物提示工具中增加具体的声望奖励"] = "Add specific reputation rewards to the Waylaid Supplies tooltip."
    ...
    L["击中"] = "Hit"
    L["所有法术和魔法效果所造成的伤害和治疗效果"] = "Damage and healing from all spells and magical effects"
    ...
    L["拍卖WA版本"] = "Auction WA version"
    L["拍卖：%s"] = "Auction: %s"
    L["需全团安装拍卖WA，没安装的人将会看不到拍卖窗口"] = "The Auction WA must be installed by the whole raid. Players without it cannot see the auction window."
    ...
    L["全新的拍卖方式，不再通过传统的聊天栏来拍卖装备，而是使用新的UI来拍卖。"] = "A new auction method that uses a dedicated UI instead of auctioning gear through the chat box."
    L["|cffFFFFFF安装WA：|r此WA是团员端，用于接收团长发出的拍卖消息，没安装的团员显示不了拍卖UI。请团长安装该WA字符串后发给团员安装。如果团员已经安装了BiaoGe插件并且版本在1.7.0或以上，可以不用安装该WA。"] = "|cffFFFFFFInstalled WA:|r This WA is for raid members and receives auction messages from the raid leader. Members without it cannot see the auction UI. The raid leader should install this WA string and send it to raid members. If BiaoGe AddOn version 1.7.0 or later is installed, this WA is not required."
    L["|cffFFFFFF拍卖教程：|r团长/物品分配者ALT+点击表格/背包/聊天框的装备来打开拍卖面板，填写起拍价、拍卖时长、拍卖模式即可开始拍卖。可同时拍卖多件装备。"] = "|cffFFFFFFAuction Tutorial:|rRaid Leader/Loot Distributor ALT-click gear in the table, bags, or chat frame to open the auction panel. Enter the starting bid, auction duration, and auction mode to start the auction. Multiple pieces of gear can be auctioned at the same time."
    ...
    L["你已退出%s频道，YY评价模块自动关闭。"] = "You have left the %s channel. The YY rating module has been disabled automatically."
    ...
    L["在地下城和团队副本界面增加一键指定%s按钮。"] = "Add a one-click Assign %s button to the Dungeons & Raids panel."
    ...
    L["BOSS击杀成功"] = "Boss Kill Succeeded"
    L["BOSS击杀失败"] = "Boss Kill Failed"
    ...
    L["< YY评价 >"] = "< YY Rating"
    L["|cff808080（右键：开启/关闭该模块）|r"] = "|cff808080 (Right click: enable/disable this module)|r"
    ...
    L["替换集结号的评价框，击杀当前版本团本尾王后弹出"] = "Replace the Rally rating popup; appears after killing the final boss of the current-version raid."
    L["< 团本攻略 >"] = "< Raid Guide >"
    ...
    L["装备属性中包含特定词缀时，就会被过滤。例如勾选了力量，如果装备中有力量属性，则该装备会被过滤"] = "Gear is filtered when its stats contain selected affixes. For example, if Strength is checked and the gear has Strength, it will be filtered."
    ...
    L["攻击强度"] = "Attack Power"
    L["精准"] = "Expertise"
    L["护甲穿透"] = "Armor Penetration"
    L["近战攻击"] = "Melee Attack"
    L["远程攻击"] = "Ranged Attack"
    L["例如勾选了单手剑，如果装备是单手剑，则会被过滤"] = "For example, if One-Handed Swords is checked, one-handed sword gear will be filtered."
    L["武器类型过滤"] = "Weapon Type Filter"
    L["例如勾选了布甲，如果装备是布甲，则会被过滤"] = "For example, if Cloth is checked, Cloth gear will be filtered."
    L["护甲类型过滤"] = "Armor Type Filter"
    L["像套装兑换物这种有职业限定的装备，不适合你的会被过滤"] = "Class-restricted gear, such as set tokens, will be filtered if it is not for your class."
    L["职业限定过滤"] = "Class Restriction Filter"
    L["没有%s任一属性的装备会被过滤（武器、饰品、圣物除外）"] = "Gear without any %s stat will be filtered (except weapons, trinkets, and relics)."
    ...
    L["过滤没有坦克属性的装备"] = "Filter gear without tank stats"
    L["周常"] = "Weekly"
    L["该周常是指达拉然的周常，不是ICC副本内的周常"] = "This refers to the Dalaran weekly quest, not the weekly quest inside ICC."
    L["没有%s属性的装备（武器和饰品部位除外）"] = "Gear without %s stats (except weapons and trinkets)."
    L["含有%s属性的装备"] = "Gear with %s stats."
    L["如果你想关闭该功能，可在插件设置-BiaoGe-角色总览里关闭"] = "You can disable this feature in AddOn Settings - BiaoGe - Character Overview."
    ...
    L["1、对BiaoGeYY频道的在线玩家发出该YY的请求"] = "1. Send a nickname request to online players in the BiaoGeYY channel."
    L["2、如果这些玩家有该YY的评价，则会通过匿名方式把评价发送给你"] = "2. Players with a matching nickname rating send it to you anonymously."
    ...
    L["正在查询YY%s的大众评价"] = "Querying public ratings for %s"
    L["详细"] = "Detailed"
    ...
    L["查询成功：YY%s的评价|cffFFFFFF一共%s个|r。|cff00FF00好评%s个|r，|cffFFFF00中评%s个|r，|cffDC143C差评%s个。|r%s"] = "Query successful: %s has |cffFFFFFF%s ratings|r: |cff00FF00%s good|r / |cffFFFF00%s neutral|r / |cffDC143C%s bad|r. %s"
    L["查询成功！CD"] = "Query Successful!"
    L["你的评价可以帮助别人辨别该团好与坏\n当其他玩家查询大众评价而你有该YY的评价时，会以匿名的方式发送给对方"] = "Your rating can help others judge a group.\nWhen another player queries a matching nickname, your rating is sent anonymously."
    ...
    L["|cffffffff< 团本攻略字体大小 >|r|cff808080（右键还原设置）|r\n\n1、调整该字体的大小"] = "|cffffffff< Raid Guide Font Size >|r|cff808080 (Right click to restore settings)|r\n\n1. Adjust this font size."
    L["团本攻略字体大小"] = "Raid Guide Font Size"
    L["|cffffffff< 密语模板 >|r\n\n1、预设成就、装等、自定义文本，当你点击集结号活动密语时会自动添加该内容\n2、按住SHIFT+点击密语时不会添加"] = "|cffffffff< Whisper Template >|r\n\n1. Preset achievements, item level, and custom text are automatically added when you whisper a Rally activity.\n2. They are not added when you hold SHIFT and click whisper."
    L["密语模板"] = "Secret message template"
    L["< 历史搜索记录 >"] = "< Search History >"
    L["|cffFFFFFF左键：|r搜索该记录\n|cffFFFFFF右键：|r删除该记录"] = "|cffFFFFFFLeft: |rSearch this record\n|cffFFFFFFRight: |rDelete this record"
    L["把搜索文本添加至历史记录"] = "Add search text to history"
    ...
    L["按队伍人数排序"] = "Sort by team size"
    L["|cffFFFFFF左键：|r搜索该记录\n|cffFFFFFF右键：|r删除该记录"] = "|cffFFFFFFLeft click:|r Search this record\n|cffFFFFFFRight click:|r Delete this record"
    L["集结号"] = "MeetingHorn"
    L["|cffffffff< 历史搜索记录 >|r\n\n1、给集结号的搜索框增加一个历史搜索记录，提高你搜索的效率"] = "|cffffffff< Search History >|r\n\n1. Add search history to the Rally search box to improve search efficiency."
    L["历史搜索记录"] = "Search History"
    ...
    L["|cffffffff< YY评价 >|cff808080（右键：开启/关闭该模块）|r|r\n\n1、你可以给YY频道做评价，帮助别人辨别该团好与坏\n2、你可以查询YY频道的大众评价\n3、聊天频道的YY号变为超链接，方便你复制该号码或查询大众评价\n4、替换集结号的评价框，击杀当前版本团本尾王后弹出\n"] = "|cffffffff< YY Rating >|cff808080 (Right click: enable/disable this module)|r|r\n\n1. You can rate YY channels to help others judge raid quality.\n2. You can query public YY ratings.\n3. YY numbers in chat become hyperlinks for easier copying or public rating lookup.\n4. Replaces the Rally rating popup after killing the final boss of the current-version raid.\n"
    L["模块开关"] = "Module switch"
    L["开启"] = "Enable"
    L["该模块已关闭。右键底部标签页开启"] = "This module is disabled. Right-click the bottom tab to enable it."
    L["< 历史搜索记录 >"] = "< Search History >"
    L["把搜索文本添加至历史记录"] = "Add search text to history"
    L["团本攻略"] = "Group Tips"
    ...
    L["治疗预警"] = "Healing Warning"
    L["英雄难度"] = "Heroic Difficulty"
    L["灭团技能"] = "Extermination Skills"
    L["重要"] = "Important"
    L["可打断技能"] = "Interruptible Abilities"
    L["法术效果"] = "Spell Effects"
    L["诅咒"] = "Curse"
    L["中毒"] = "Poison"
    L["疾病"] = "Undead Slayer 108"
    L["坦克职责"] = "Tank Duty"
    L["治疗职责"] = "Healing Duties"
    L["输出职责"] = "Output Duty"
    L["近战职责"] = "Melee Duty"
    L["远程职责"] = "Ranged Duty"
    ...
    L["团长YY（根据聊天记录帮你生成）"] = "Raid Leader YY (generated from chat logs)"
    L["详细评价"] = "Detailed Evaluation"
    L["< 快速评价 >"] = "< Quick Evaluation >"
    L["恭喜你们击杀尾王！请给团长个评价吧！"] = "Congratulations on killing the final boss! Please rate the raid leader."
    L["YY号必填，填写数字"] = "Nickname is required"
    L["评价:"] = "Rating."
    L["评价必填，默认中评"] = "Required, default rating"
    L["必填"] = "Required field"
    L["修改评价"] = "Modify Evaluation"
    L["详细评价"] = "Detailed evaluation"
    L["感谢你的评价：YY%s，|cff%s%s|r"] = "Thank you for rating %s: |cff%s%s|r"
    L["保存"] = "Save"
    L["详细评价"] = "Detailed Evaluation"
    L["|cffffffff< 详细评价 >|r\n\n1、在金团表格里写详细评价"] = "|cffffffff< Detailed Evaluation >|r\n\n1, Write Detailed Evaluation in Golden Group Form"
    L["|cffffffff< 修改评价 >|r\n\n1、该YY号已有评价，去金团表格里修改评价"] = "|cffffffff< Modify Evaluation >|r\n\n1. This nickname already has a rating; edit it in the main form."
    L["退出"] = "Exit"
    ...
    L["|cffffffff< 交易通知字体大小 >|r|cff808080（右键还原设置）|r\n\n1、调整该字体的大小"] = "|cffffffff< Trade Notification Font Size >|r|cff808080 (right-click to restore settings)|r\n\n1. Adjust this font size."
    ...
    L["心愿清单"] = "Wish List"
    L["YY评价"] = "YY Evaluation"
    L["团员插件版本"] = "Raid Member AddOn Version"
    ...
    L["{rt7}倒数暂停{rt7}"] = "{rt7}Countdown Paused{rt7}"
    ...
    L["|cffffffff< 共享我的评价 >   （你已共享|r |cff00FF00%s|r |cffffffff人次评价）|r\n\n1、当别人查询大众评价时，如果你有该YY的评价，则会以匿名的方式共享给对方\n2、如果你不开启该功能，则你的查询大众评价功能会被禁用，因为共享是相互的\n3、开启该功能后，会使聊天记录里的YY号变为超链接\n4、没满级的角色会被禁止共享和使用查询大众评价"] = "|cffffffff< Share My Rating > (You have shared |r |cff00FF00%s|r |cffffffff ratings)|r\n\n1. When another player queries a nickname you rated, the rating is shared anonymously.\n2. Public lookup is disabled when sharing is off because sharing is mutual.\n3. Existing YY numbers in chat remain clickable lookup links.\n4. Characters below max level cannot share or use public lookup."
    ...
    L["|cffffffff< 保存评价 >|r\n\n1、必填项填完才能保存\n2、同一个YY只能写一次评价，但你可以修改之前的评价"] = "|cffffffff< Save Evaluation >|r\n\n1. Required fields must be completed.\n2. Each nickname can have one rating, which you can edit later."
    L["退出修改"] = "Exit Modify"
    L["该YY已有评价，需要修改吗？"] = "This nickname already has a rating. Modify it?"
    ...
    L["|cffffffff< 共享我的评价 >   （你已共享|r |cff00FF00%s|r |cffffffff人次评价）|r\n\n1、当别人查询大众评价时，如果你有该YY的评价，则会以匿名的方式共享给对方\n2、如果你不开启该功能，则你的查询大众评价功能会被禁用，所以共享是相互的\n3、没满级的角色会被禁止共享和使用查询大众评价"] = "|cffffffff< Share My Rating > (You have shared |r |cff00FF00%s|r |cffffffff ratings)|r\n\n1. A rating is shared anonymously when another player queries its nickname.\n2. Public lookup is disabled when sharing is off because sharing is mutual.\n3. Characters below max level cannot share or use public lookup."
    L["理由"] = "Reason"
    L["好评"] = "Good"
    L["中评"] = "Medium"
    L["差评"] = "Bad"
    ...
    L["保存修改"] = "Save changes"
    L["（左键修改评价，SHIFT+左键把yy号发到查询里，ALT+右键删除评价）"] = "(Left click to edit, SHIFT+Left click to query the nickname, ALT+Right click to delete)"
    L["< 查询大众评价 >"] = "< Query public evaluation >"
    L["查询成功：YY%s的评价|cffFFFFFF一共%s个|r。|cff00FF00好评%s个|r，|cffFFFF00中评%s个|r，|cffDC143C差评%s个|r"] = "Query successful: %s has |cffFFFFFF%s ratings|r: |cff00FF00%s good|r / |cffFFFF00%s neutral|r / |cffDC143C%s bad|r"
    L["查询成功！CD"] = "Query Successful!"
    L["查询"] = "Query"
    L["无"] = "No"
    L["查询失败：没有找到YY%s的评价。"] = "Query failed: no ratings found for %s."
    L["查询中 "] = "Query in"
    L["个)|r"] = "individual)|r"
    L["无"] = "None"
    L["无"] = "None"
    ...
    L["|cffffffff< 金额自动加零 >|r\n\n1、输入金额和欠款时自动加两个0，减少记账操作，提高记账效率"] = "|cffffffff< Amount Auto-Zero >|r\n\n1. Automatically add two zeros when entering amounts and debts to reduce bookkeeping work and improve efficiency."
    ...
    L["经典旧世"] = "Legacy "
    L["货币"] = "Currency"
    L["|cffffffff< 清空表格时根据副本难度设置分钱人数 >|r\n\n1、10人团本默认分钱人数为10人\n2、25人团本默认分钱人数为25人"] = "|cffffffff< Set Payout Count by Instance Difficulty When Clearing Table >|r\n\n1. The default payout count for a 10-player raid is 10.\n2. The default payout count for a 25-player raid is 25."
    L["清空表格时根据副本难度设置分钱人数"] = "Set payout count by instance difficulty when clearing the table."
    L["|cffFFFFFF10人团本分钱人数：|r"] = "|cffFFFFFF10M Raid Share Mem Cnt: |r"
    L["|cffFFFFFF25人团本分钱人数：|r"] = "|cffFFFFFF25M Raid Share Mem Cnt: |r"
    L["快捷命令：/BGO"] = "Shortcut command: /BGO"
    L["|cffffffff< 清空表格时保留支出补贴名称 >|r\n\n1、只保留补贴名称（例如XX补贴），支出玩家和支出金额正常清空\n2、这样就不用每次都重复填写补贴名称\n3、只有补贴名称，但没有补贴金额的，在通报账单时不会被通报"] = "|cffffffff< Keep Subsidy Names When Clearing the Table >|r\n\n1. Only subsidy names are kept (for example, XX Subsidy); expense players and amounts are cleared normally.\n2. This avoids entering the same subsidy names repeatedly.\n3. Subsidies with a name but no amount are not included when reporting the bill."
    ...
    L["关闭心愿清单"] = "Close Wishlist"
    L["清空当前心愿"] = "Empty the current wish list"
    L["对账"] = "Reconciliation"
    L["关闭对账"] = "Close Reconciliation"
    ...
    L["你可以前往curseforge搜索biaoge更新"] = "You can search for BiaoGe updates on CurseForge"
    L["< BiaoGe > 金团表格载入成功。插件命令：%s或%s，小地图图标：%s"] = "< BiaoGe > GDKP table loaded. AddOn command: %s or %s, minimap icon: %s"
    L["星星"] = "Stars"
    ...
    L["当前团队还有 %s 人也许愿该装备！"] = "%s other players in the current raid also have this item on their wishlist!"
    L["查询心愿竞争"] = "Check Wish Competition"
    L["查询团队里，有多少人许愿跟你相同的装备"] = "Check how many players in your raid have the same wishlist item"
    L["不在团队，无法查询"] = "Cannot check when you are not in a raid."
    L["恭喜你，当前团队没人许愿跟你相同的装备"] = "No one in your current raid has the same item on their wishlist."
    ...
    L["|cffffffff< 金额自动加零 >|r\n\n1、输入金额和欠款时自动加两个0\n    减少记账操作，提高记账效率\n"] = "|cffffffff< Amount Auto-Zero >|r\n\n1. Automatically add two zeros when entering amounts and debts.\n   Reduces bookkeeping work and improves efficiency.\n"
    ...
    L["通知锁定"] = "Notify Lock"
    L["通知移动"] = "Move"
    L["调整装备记录通知和交易通知的位置\n快捷命令：/BGM"] = "Adjust Gear Record and Trade notification positions.\nShortcut command: /BGM"
