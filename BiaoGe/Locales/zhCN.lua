...
do --简体说明书
    ns.instructionsText = {
        ...
        " ",
        "|cffFFFFFF-打开命令：|r/BiaoGe或/GBG，或游戏设置里绑定按键。小地图图标： " .. "|TInterface\\AddOns\\BiaoGe\\Media\\icon\\icon.tga:16:16:0:0|t",
        "|cffFFFFFF-快捷操作：|r|TInterface\\AddOns\\BiaoGe\\Media\\icon\\rightc.tga:16:16:0:0|t输入框清除内容",
        ...
        "|cffFFFFFF-拍卖倒数：|r|TInterface\\AddOns\\BiaoGe\\Media\\icon\\rightc.tga:16:16:0:0|t聊天框装备开始拍卖自动倒数（当你是团长或物品分配者时）",
        "|cffFFFFFF-快速记账：|r|TInterface\\AddOns\\BiaoGe\\Media\\icon\\rightc.tga:16:16:0:0|t聊天框装备时打开（当你是团员时）",
    ...
    ns.updateText_now = {
        ...
        -- [[]] ,
        -- " " ,
        "|cff00FF00" .. [[4月18日更新v1.27.3]],
        [[增加功能：本次交易为退货（按钮在交易界面右侧的记账效果预览框）]],
        [[拍卖记录：增加一个筛选项"重拍"]],
        [[集结号：增加选项"简化活动列表"（默认不勾选），活动列表的无用信息不再显示，使得说明文本可显示更多内容]],
        [[<时光服>AtlasLoot快捷按钮：增加十字军、祖格、烹饪]],
        [[<MOP>AtlasLoot快捷按钮：增加雷电、T15、烹饪]],
        " ",
    }
    ns.updateText_before = {
        "|cff00FF00" .. [[4月11日更新v1.27.2]],
        [[修复了角色总览的装等显示为0的问题]],
        [[<时光服>装备库：更新P4装备]],
        [[<时光服>自动拍卖：由于服务器限流，自动出价的出价速度从0.5秒增加至1.5秒]],
        [[<时光服>分享表格：由于服务器限流，现在副本内无法分享表格，需要发送者出本后才能发送]],
        [[<时光服>竞拍欢呼语：由于服务器限流，暂时取消该功能]],
        [[<时光服>切换橙脖时，不再自动记录到表格]],
        " ",
        "|cff00FF00" .. [[4月9日更新v1.27.1]],
        [[拍卖记录：增加一个筛选项"我买的"]],
        [[对账：相同的多件装备进行价格对比时，现在是对比多件装备的价格合计，合计相同则显示绿色勾勾]],
        [[<时光服>装备库：修复了装绑装备不显示EasyAuction缓存价格的问题]],
        " ",
        "|cff00FF00" .. [[4月6日更新v1.26.9]],
        [[拍卖记录：增加一个筛选项"拍卖成功但未交易"]],
        [[装备过期提醒：修复了该功能失效的问题]],
        [[<时光服>增加P4双本表格]],
        [[<时光服>世界BOSS拾取框：恢复原有的"记录到表格"按钮]],
        [[<时光服>一键拾取：没有指定橙片老板时，一键拾取现在也会把橙片拾取到自己身上]],
    }
    ...
    tinsert(ns.VIPinstructionsText, " ")
    tinsert(ns.VIPinstructionsText, "|cff00ff00|TInterface\\AddOns\\BiaoGe\\Media\\icon\\leftc.tga:16:16:0:0|t打开订阅网站")
end
