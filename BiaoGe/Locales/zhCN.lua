...
do --简体说明书
    ns.instructionsText = {
        ...
        "|cffFFFFFF-快捷操作：|r|TInterface\\AddOns\\BiaoGe\\Media\\icon\\rightc:16:16|t输入框清除内容",
        ...
        "|cffFFFFFF-拍卖倒数：|r|TInterface\\AddOns\\BiaoGe\\Media\\icon\\rightc:16:16|t聊天框装备开始拍卖自动倒数（当你是团长或物品分配者时）",
        "|cffFFFFFF-快速记账：|r|TInterface\\AddOns\\BiaoGe\\Media\\icon\\rightc:16:16|t聊天框装备时打开（当你是团员时）",
